...
const Bienes = ({ setTitle }) => {
  ...
  const columns = [
    ...
    {
      title: (
        <div style={{ textAlign: "center" }}>ESPECIFICACIONES TÉCNICAS</div>
      ),
      render: (_, record) =>
        record?.terminado ? (
  ...
  const handleSearch = (e) => {
    ...
    const filterData = bienes.filter(
      (item) =>
              ...
              <Flex gap={"20px"} justify="center" align="center">
                <Tooltip title="ORDEN DE PRESENTACIÓN DE DOCUMENTOS">
                  <FilePdfOutlined
                    ...
                    onClick={() => {
                      window.open(
                        "https://requerimientos.pems.pe/uploads/orden-presentacion-compras.pdf",
                        "_blank"
                      );
                    }}
                  />
                ...
                <Tooltip title="FORMATO 07 DECLARACION JURADA">
                  <FilePdfOutlined
                    ...
                    onClick={() => {
                      window.open(
                        "https://requerimientos.pems.pe/uploads/FORMATO%2007.pdf",
                        "_blank"
                      );
                    }}
                  />{" "}
                ...
                <Tooltip title="FORMATO 05">
                  <FilePdfOutlined
                    ...
                    onClick={() => {
                      window.open(
                        "https://requerimientos.pems.pe/uploads/FORMATO%2005.pdf",
                        "_blank"
                      );
                    }}
                  />{" "}
                ...
                <Tooltip title="FORMATO N° 06 PROPUESTA ECONOMICA">
                  <FileWordOutlined
                    ...
                    onClick={() => {
                      window.open(
                        "https://requerimientos.pems.pe/uploads/FORMATO%20N%C2%B0%2006%20PROPUESTA%20ECONOMICA.docx",
                        "_blank"
                      );
                    }}
                  />
          ...
          <Alert
            ...
            description={
              <>
                ...
                <strong>
                  compras@pems.pe, con copia al correo logistica_control@pems.pe
                  o Trámite Documentario de la entidad.
                </strong>
                <br />
                2. En el asunto del correo se deberá colocar el número de
                pedido.
                <br />
                3. En caso de bienes específicos adjuntar la{" "}
                <strong>Ficha Técnica</strong> del producto ofertado.
              </>
            }
            type="warning"
            showIcon
